...
<body class="d-flex justify-content-center align-items-center" style="min-height:100vh;">
    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal"> Register</button>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body ">
                    ...
                    <div class="row">
                        <div class="col-lg-6 my-1">
                                <label for="name" class="col-lg-12 control-label">លេខអត្តសញ្ញាណ</label>
                                <input type="number" class="form-control" name="name" id="name">
                                <label for="name" class="col-lg-12 control-label">ភេទ</label>
                ...
                <div class="modal-footer">
                        <button type="button" class="btn btn-outline-primary btn-sm" data-bs-dismiss="modal" style="display: flex; gap: 5px;">
